    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="onSubmit" method="POST">
        ...
        <div class="flex items-center justify-between">
          <div class="text-sm">
            <a href="#" class="font-medium text-teknikfokus-primary hover:text-teknikfokus-primary-light">
              Forgot your password?
            </a>
          </div>

          <div>
            <router-link to="/registration" class="relative justify-center py-2 text-sm font-medium hover:underline">
              Create account
            </router-link>
          </div>
        </div>
